...
def test_h5_correspondence(gt_file: str, noisy_file: str, sample_index: int = 0, 
    ...
    try:
        ...
        noisy_point_cloud = np.clip(noisy_point_cloud, 0, [args.volume_dims[0]-1, args.volume_dims[1]-1, args.volume_dims[2]-1])
        ...
        if len(noisy_point_cloud) > 0:
            noisy_csv_path = os.path.join(output_dir, f"noisy_sample_{sample_index}.csv")
