...
from torch.nn import Sequential as Seq, Linear as Lin, ReLU, Dropout, SiLU

from torch.nn import Identity as BatchNorm1d

from torch_geometric.nn import fps, radius, knn
from torch_geometric.nn.conv import PointConv, MessagePassing
...
class PointConvFP(MessagePassing):
    ...
    def __init__(self, mlp=None):
        super(PointConvFP, self).__init__(aggr='add', flow='source_to_target')
        self.mlp = mlp
        self.aggr = 'add'
